...
subscribe_subtypes = [ SubType.QUOTE, SubType.K_1M, SubType.K_5M, SubType.RT_DATA ]
...
kline_hadler = CurKlineTest()
rtdata_handler = RTDataTest()
# quote_ctx.set_handler(orderbook_handler)
# quote_ctx.set_handler(ticker_handler)
quote_ctx.set_handler(quote_handler)
quote_ctx.set_handler(kline_hadler)
quote_ctx.set_handler(rtdata_handler)
